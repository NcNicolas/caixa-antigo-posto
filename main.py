...
print(f"{'Gasolina':<11} | {'Gasolina':<11} | {'Gasolina':<11} | {'V-Power'}")
print(GREEN + f"{Bomba_comum:<11}" + RESET,"|",GREEN + f"{Bomba_comum2:<11}" + RESET, "|", GREEN + f"{Bomba_comum4:<11}" + RESET,"|", GREEN +
      f"{Bomba_adv}" + RESET)
print(RED + f"{Bomba1_comum:<11}" + RESET,"|",RED + f"{Bomba_comum3:<11}" + RESET, "|",RED  + f"{Bomba_comum5:<11}" + RESET,"|", RED +
      f"{Bomba_adv2}" + RESET)
print(GREEN + f"{result_bomba:<11}" + RESET,"|",GREEN + f"{result_bomba2:<11}" + RESET, "|",GREEN  + f"{result_bomba3:<11}" + RESET,"|", GREEN +
      f"{result_bomba4}" + RESET)
print("")
print("")
print(f"{'S-10':<11} | {'S-10':<11} | {'S-500':<11}")
print(GREEN + f"{bomba_s10:<11}" + RESET,"|",GREEN + f"{bomba_s101:<11}" + RESET, "|", GREEN + f"{bomba_s500:<11}"+ RESET)
print(RED + f"{bomba_s102:<11}" + RESET,"|",RED + f"{bomba_s103:<11}" + RESET, "|",RED  + f"{bomba_s5002:<11}" + RESET)
print(GREEN + f"{result_bomba5:<11}" + RESET,"|",GREEN + f"{result_bomba6:<11}" + RESET, "|", GREEN + f"{result_bomba7:<11}"+ RESET)
print("")
print("")
...
print(GREEN + f"{valor_litros_gasolina:<11}" + RESET,"|",GREEN + f"{valor_litros_s10:<11}" + RESET, "|", GREEN + f"{valor_litros_s500:<11}" + RESET,"|", GREEN +
      f"{valor_litros_vpower}" + RESET)
print(RED + f"{total_gasolina:<11}" + RESET,"|",RED + f"{total_s10:<11}" + RESET, "|", RED + f"{result_bomba7:<11}" + RESET,"|", RED +
      f"{result_bomba4}" + RESET)
print(GREEN + f"{valor_litros_gasolina - total_gasolina:>11}" + RESET,"|", GREEN + f"{valor_litros_s10 - total_s10:<11}" + RESET, "|",
        GREEN + f"{valor_litros_s500 - result_bomba7:<11}" + RESET,"|", GREEN + f"{valor_litros_vpower - result_bomba4}" + RESET)
